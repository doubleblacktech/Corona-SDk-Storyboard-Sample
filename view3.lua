...
print("view3: createScene()")
	...
	local summary = display.newText( "Loaded by the third tab 'onPress' listener\n— specified in the 'tabButtons' table.", 0, 0, 300, 300, native.systemFont, 14 )
